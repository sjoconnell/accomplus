...
<!--             <div class="orange-rectangle"></div>
            ...
            <div class="container">
                <div class="banner-text">
                    <h2><?php the_field('compliance_banner_title');?></h2>
                    <p><?php the_field('compliance_banner_text');?></p>
                </div>
            </div>
        </div>
        ...
        <div class="page-content">
            <div class="container">
                <div class="compliance-text">
                    <h3><?php the_field('compliance_main_title');?></h3>
                    <p><?php the_field('compliance_main_top_text');?></p>
                    <p><?php the_field('compliance_main_bottom_text');?></p>
                </div>
                <div class="compliance-categories">
                <?php while( have_rows('compliance-boxes') ): the_row(); ?>
